...
if ($accion=="alta") {
	...
	$query_operacion="INSERT INTO mesas(mes_cod,mes_des,fecha,hora,usuario,borrado)
...
if ($accion=="modificar") {
	$variable1=$_POST["id"];
	$variable2=strtoupper($_POST["variable2"]);	
	$query="UPDATE mesas SET mes_des='$variable2',fecha='$fecha',hora='$hora',usuario='$usuario' where mes_cod='$variable1'";
