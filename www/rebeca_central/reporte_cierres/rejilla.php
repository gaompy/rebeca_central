...
$where.=" ORDER BY ape_cod desc";
$query_busqueda="SELECT count(*) as filas FROM aper_cie WHERE borrado=0 AND ".$where;
...
function imprimir(variable1) {
			miPopup = window.open("impresiones_det.php?variable1="+variable1,"miwin","width=700,height=380,scrollbars=yes");
			miPopup.focus();
		}
		...
		<div id="pagina">
			...
			<input type="hidden" name="numfilas" id="numfilas" value="<?php echo $filas; ?>">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						<?php $sel_resultado="SELECT *,(SELECT usuario FROM usuarios WHERE id=aper_cie_view.usuario) AS usu_des 
             FROM aper_cie_view where borrado='0' and ".$where;
						   include("sql.php");
						...
						while ($contador < mysql_num_rows($res_resultado)) {
						  ...
						  <tr class="<?php echo $fondolinea;?>">						
							...
							<td width="25%"><div align="left"><?php echo strtoupper(mysql_result($res_resultado,$contador,"ape_dot"));?></div></td>
						  <td width="5%"><div align="center"><a href="javascript:imprimir(<?php echo mysql_result($res_resultado,$contador,"ape_cod")?>)"><img src="../img/imprimir.png" width="16" height="16" border="0"  title="Imprimir"></a></div></td>
							</tr>
						<?php $contador++;
							}
						?>			
