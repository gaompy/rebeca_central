			...
			<div align="center">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
				   ...
				   <td height="103"><p>&nbsp;</p>
				     ...
				     <p>&nbsp;</p></td>
				<td><p>
				  <input id="variable2" type="text" class="cajaPequena"  NAME="variable2" maxlength="10" readonly>
				  ...
				  <input id="variable3" type="text" class="cajaPequena"  NAME="variable3" maxlength="10" readonly>
