		...
		<div id="pagina">
			...
			<div align="center">
              ...
              <option value="1">Facturas</option>
						...
						<tr>
							<td width="16%"><p>Factura</p></td>
							<td width="68%"><input id="variable_fac" type="text" class="cajaGrande" NAME="variable_fac" maxlength="45"  onChange="buscar()">  <img src="../img/ver.png" width="16" height="16" onClick="buscar()" title="Buscar Materia" onMouseOver="style.cursor=cursor"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="6%" align="right"></td>
						</tr>
						...
						<tr>
							<td width="16%"><p>Apertura</p></td>
							<td width="68%"><input id="variable4" type="text" class="cajaPequena" NAME="variable4" maxlength="10"  onChange="buscar()">  <img src="../img/ver.png" width="16" height="16" onClick="buscar()" title="Buscar Materia" onMouseOver="style.cursor=cursor"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
							<td width="6%" align="right"></td>
						</tr>
