...
$query="SELECT * FROM tipo_cliente WHERE tic_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=strtoupper(mysql_result($rs_query,0,"tic_des"));
$variable3=strtoupper(mysql_result($rs_query,0,"tic_por"));
...
function guardar()
        ...
        if (document.getElementById("variable3").value=="") mensaje+="  - Descuento %\n";
				if (mensaje!="") {
					alert("Atencion, Faltan Datos:\n\n"+mensaje);
          
 			    }else {
          		if (isNaN(document.getElementById("variable3").value)==true) {
