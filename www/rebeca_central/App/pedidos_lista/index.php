...
<form id="form_busqueda" name="form_busqueda" action="rejilla.php" target="frame_rejilla" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:16px;font-family:Arial,Helvetica,sans-serif;color:#00557f;max-width:680px;min-width:150px" method="post" autocomplete="off">
	...
	<div class="title">
  <h2><? echo strtoupper("Lista de ".$descripcion); ?></h2></div>
	<div class="element-input"><label class="title"><b>Pedido Nro.</b><span></span></label><input class="large" type="text" name="variable1" id="variable1"/></div>
	<div class="element-input"><label class="title"><b>Cliente</b><span></span></label><input class="large" type="text" name="variable2" id="variable2"/></div>
<div class="submit">
  <p>
