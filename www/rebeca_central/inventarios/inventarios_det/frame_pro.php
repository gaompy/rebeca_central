...
<? if ($nrs>0) { ?>
        ...
        <div align="right"><?php echo $variable7;?></div></td>	
					...
					<td align="center"><div align="center"><a href="javascript:pon_prefijo('<?php echo $variable1?>','<?php echo $variable2?>','<?php echo $variable7; ?>','<?php echo $codigopro; ?>')"><img src="../../img/convertir.png" border="0" title="Seleccionar"></a></div></td>					
				</tr>
			<?php }
		?>
  </table>
