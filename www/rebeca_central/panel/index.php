...
?>
  ...
  ?>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">REBECA CENTRAL</a>
         ...
         $sel_lineas="select * from factura_cab_view 
          ...
          limit 0,10";
               ...
               <?
                 ...
                 <td><span><b>Orden</b></span></td>
                 <td><span><b>Ticket</b></span></td>
                 
                 <td><span><b>Pedido</b></span></td>
                 <td><span><b>Importe</b></span></td>
               ...
               <? } 
                        ...
                        if ($i==0){
                         ...
                         $sel="SELECT fac_cod,pro_cod,pro_can, pro_tot,
                        ...
                        (SELECT pro_des FROM productos WHERE pro_cod=factura_det.pro_cod) AS pro_des
                         ...
                         for ($j = 0; $j < mysql_num_rows($rs); $j++) {
                            ...
                            $pro_tot=mysql_result($rs,$j,"pro_tot");
                            $pago=$pago+$pro_tot;
                     ...
                     <td><span class="skills"><b><?php echo $i+1;?></b></span></td>
                      ...
                      <td><span class="skills"><b><?php echo number_format($pago, 0, ",", ".");?></b></span></td>
                     ...
                     if ($i==1){
                     ?>
                     <td><a href="javascript:confirmar('<?php echo $fac_cod?>')"><img src="img/azul.png" width="90" height="90" /></td>
                     <?php
                      }
                     ?>
                     ...
                     if ($i > 1){
                     ?>
                     <td><a href="javascript:confirmar('<?php echo $fac_cod?>')"><img src="img/rojo.png" width="60" height="60" /></td>
                     <?php
                      }
                     ?>
