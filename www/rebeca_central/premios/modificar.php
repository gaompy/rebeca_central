...
$query="SELECT *, 
(CASE prm_est WHEN 0 THEN 'Pendiente' WHEN 1 THEN 'Sorteado' END)AS prm_par_des
FROM promo_cab WHERE prm_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=strtoupper(mysql_result($rs_query,0,"prm_des"));
$variable3=strtoupper(mysql_result($rs_query,0,"prm_est"));
$variable3_1=strtoupper(mysql_result($rs_query,0,"prm_par_des"));
