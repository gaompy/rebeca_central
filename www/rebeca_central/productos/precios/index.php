...
<html>
    ...
    document.getElementById("precio").value="";
      ...
      location.href="../index.php?variable1="+variable1+"&variable2="+variable2+"&variable3="+variable3;
        ...
        if (document.getElementById("costo").value=="") mensaje+="  - Costo\n";
        if (document.getElementById("precio").value=="") mensaje+="  - P.Venta\n";
...
<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">COSTOS Y PRECIOS</div>
				<div id="frmBusqueda">
			   ...
			   <div id="frmBusqueda">
				<form id="formulario_lineas" name="formulario_lineas" method="post" action="frame_lineas.php" target="frame_lineas">
				  ...
				  <tr>
					...
					<td>Descripcion</td>
					<td width="19%"><input NAME="descripcion" type="text" class="cajaGrande" id="descripcion" size="200" maxlength="200"></td>
				  <tr>

					<td width="5%">Costo</td>
					<td width="1%"><input NAME="costo" type="text" onkeyup="format(this)" onchange="format(this)"  class="cajaMedia" id="costo" size="10" maxlength="10"></td>
			        	  <tr>
						<td width="17%">P.Venta</td>
					<td width="14%"><input NAME="precio" type="text" onkeyup="format(this)" onchange="format(this)"  class="cajaMedia" id="precio" size="10" maxlength="10"</td>
					<tr>	
