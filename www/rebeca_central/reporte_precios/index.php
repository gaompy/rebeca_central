				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="variable1" type="text" class="cajaMedia" NAME="variable1" maxlength="45"  onChange="buscar()">  <img src="../img/ver.png" width="16" height="16" onClick="buscar()" title="Buscar Materia" onMouseOver="style.cursor=cursor"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
				   ...
				   <?php
					  $query="SELECT pde_des FROM productos_det_view WHERE borrado=0
                GROUP BY pde_des ORDER BY pde_des";
					  ...
					  ?>						
						...
						<td width="15%">Tipo</td>
							...
							<option value="">Todos</option>
								...
								<option value="<?php echo mysql_result($res,$contador,"pde_des")?>"><?php echo strtoupper(mysql_result($res,$contador,"pde_des"))?></option>
								<?php $contador++;
								} ?>				
								</select>							</td>
				        </tr>				 
