...
$apertura=$_SESSION["ape_cod"] ;
$aps_cod=$_SESSION["aps_cod"] ;
...
$rs=mysql_query($sel);
    ...
    $mes_est=mysql_result($rs,0,"mes_est");
    ...
    $nro_fac=$_GET['mesfac'];
    $mes_est=$_GET['estado'];
    $mes_des=strtoupper($_GET['mes_des']);
    $par=$_GET['par'];
}
			   ...
			   <div id="frmBusqueda">
				<form id="formulario_lineas" name="formulario_lineas" method="post" action="frame_lineas.php" target="frame_lineas">
				  ...
				  <tr>
					...
					<td colspan="9"><input NAME="variable6" type="text" class="cajaMedia" id="variable6" size="50" maxlength="50" onChange="validarproducto()"> <img src="../img/ver.png" width="16" height="16" onClick="ventanaArticulos()" onMouseOver="style.cursor=cursor" title="Buscar Producto"></td>
				  <tr>
					<td>Descripcion</td>
