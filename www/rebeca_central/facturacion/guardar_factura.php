...
var celular=document.getElementById("celular").value;
        ...
        if (document.getElementById("celular").value=="") mensaje+="  - Celular\n";
					...
					alert("Atencion, Faltan Datos:\n\n"+mensaje);
                     ...
                     //if (confirm(" Desea Cerrar Venta? ")){ 
                           ...
                           // window.print("reporte/impresiones_ticket.php?nrofactura="+fac_cod+"&importe="+variable5,"miwin","width=500,height=600,scrollbars=no");
                            ...
                            location.href="efectuarpago.php?variable1="+variable1+"&variable2="+variable2+"&variable3="+variable3+"&variable4="+variable4+"&variable5="+variable5+"&variable6="+variable6+"&variable7="+fac_cod+"&variable8="+cli_cod+"&mesa="+mesa+"&celular="+celular;                  
                      //}                        
					...
					<?php
					  ...
					  ?>						
						...
						<td width="6%">Importe</td>
						    <td width="27%"><input NAME="variable5" onKeyUp="format(this)"  type="text" class="cajaMedia" id="variable5" size="45" maxlength="45" value=""></td>    			
              <tr>
						<td width="6%">Celular</td>
						    <td width="27%"><input NAME="celular" onKeyUp="mascara(this,'-','4-3-3',true)"  type="text" class="cajaMedia" id="celular" size="45" value="0" maxlength="45"></td>    			
