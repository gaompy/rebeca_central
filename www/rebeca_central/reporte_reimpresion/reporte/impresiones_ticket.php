...
<span class="x">-----------------------------<br />
  <label for="variable1">&nbsp&nbsp&nbsp&nbsp<?echo "&nbsp ".strtoupper($emp_des) ?><br />
    ...
    <label for="variable1">&nbsp&nbsp&nbsp&nbsp 10 de Agosto Nro. 62 c/<br />
      </label>
    <label for="variable1">&nbsp&nbsp&nbsp&nbsp Silvano Godoy <br />
      </label>
  <label for="variable1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp San Lorenzo-Paraguay<br />
  </label>
  <label for="variable1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Tel.:021 584-279/ 570-815<br />
  <label for="variable1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Cel.:0981 201 194<br />
  </label>
  <label for="variable1">&nbsp&nbsp TICKET NRO: <?echo $variable1 ?><br />
  </label>
  <label for="variable1">&nbsp&nbsp CLIENTE: <?echo $cli_des ?><br />
  </label>
  <label for="variable1">&nbsp&nbsp (****** REIMPRESION ******)<br />
  </label>
