...
<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">actualizar facturas</div>
				<div id="frmBusqueda">
          ...
          <td width="5%">Total a rendir</td>
					<td width="1%"><input NAME="variable5" type="text" class="cajaTotales" id="variable5" size="300" maxlength="300" readonly></td>
           </tr>
          <td width="5%">Total Rendido</td>
					<td width="1%"><input NAME="variable6" type="text" class="cajaTotales" id="variable6" size="300" value="0" maxlength="300" readonly></td>
          ...
          <tr>
				   ...
				   <td width="1%"> <img src="../../img/boton-confirmar.jpg" width="90" height="27" border="0" onClick="confirmar()" onMouseOver="style.cursor=cursor" title="Confirmar"> <img src="../../img/botonimprimir.jpg" width="72" height="22" border="1" onClick="imprimir('<? echo $variable1?>')" onMouseOver="style.cursor=cursor" title="Limpiar"> <img src="../../img/botoncerrar.jpg" width="72" height="22" border="1" onClick="cancelar()" onMouseOver="style.cursor=cursor" title="Cerrar"></td>
           <td width="1%">&nbsp;</td>
				   <td width="1%">&nbsp;</td>
          </tr>
				</table>
        ...
        <input NAME="parametro" id="parametro" type="hidden" value="<? echo $parametro?>">
              ...
              <td width="2%">FACT.</td>
							...
							<td width="2%">A RENDIR</td>
              <td width="2%">ENV.RET.</td>
              <td width="2%">ENV.NO RET</td>
              <td width="2%">ACT.</td>
						</tr>
				</table>
