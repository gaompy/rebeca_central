...
$estado=strtoupper(mysql_result($rs_query,0,"estado"));
			...
			<div id="zonaContenido">
              ...
              <tr>
						  ...
						  <tr>
						    ...
						    <td width="85%" colspan="2"><?php echo $estado?></td>
					    </tr>

						  <tr>
							<td width="15%">Total GS.</td>
						    <td width="85%" colspan="2"><?php echo $total_1?></td>
					    </tr>
