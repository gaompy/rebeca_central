		...
		<div id="pagina">
            ...
            <?php
				   ...
				   <td height="103"><p>&nbsp;</p>
				     ...
				     <p>&nbsp;</p></td>
				<td><p>
				  <input id="variable5" type="text" class="cajaPequena"  NAME="variable5" value='<?echo $fecha_inicio?>' maxlength="10" readonly>
				  ...
				  <input id="variable6" type="text" class="cajaPequena"  NAME="variable6" value='<?echo $fecha?>' maxlength="10" readonly>
