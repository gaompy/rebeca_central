...
$total_uti=mysql_result($rs_tabla_uti,0,"suma");
 ...
 $query="UPDATE factura_cab 	SET 	fac_num = '$factura' , 	cli_cod = '$variable8' , 	mpg_cod = '$variable1' , 	
...
WHERE 	mes_cod = '$mesa'"; 
$rs=mysql_query($query);
//header("Location: ../reporte_app/index.php?variable1=$form&variable2=$mec_cod&variable3=$descripcion");
