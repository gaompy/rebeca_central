...
FROM tipo_moneda WHERE tmo_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=mysql_result($rs_query,0,"tmo_des");
$variable3=mysql_result($rs_query,0,"tmo_par");
$variable4=strtoupper(mysql_result($rs_query,0,"tmo_par_des"));
