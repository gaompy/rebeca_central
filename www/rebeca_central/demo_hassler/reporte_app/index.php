			...
			<div align="center">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						...
						<tr>
							<td width="16%"><p>Cliente</p></td>
							<td width="68%"><input id="variable2" type="text" class="cajaGrande" NAME="variable2" maxlength="45"  onChange="buscar()">  <img src="../img/ver.png" width="16" height="16" onClick="buscar()" title="Buscar" onMouseOver="style.cursor=cursor"></td>
						</tr>

            <tr>
							<td width="16%"><p>Vendedor</p></td>
							<td width="68%"><input id="variable3" type="text" class="cajaGrande" NAME="variable3" maxlength="45"  onChange="buscar()">  <img src="../img/ver.png" width="16" height="16" onClick="buscar()" title="Buscar" onMouseOver="style.cursor=cursor"></td>
						</tr>
