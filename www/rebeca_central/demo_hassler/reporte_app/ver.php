...
$query="SELECT *,(select cli_des from clientes where cli_cod=factura_cab.cli_cod) as cli_des 
...
<html>
    ...
    function guardar()
			{
        if (confirm(" Desea Facturar este ticket? ")){ 
...
?>  
        ...
        <br>
        <br>                
				  <td width="17%"><b>TOTAL A PAGAR : </b></td>
				  <td width="10%"><b><input name="var0" class="cajaTotales" type="text"  value="<?php echo number_format($total_pago, 0, ",", ".") ?>" id="var0" size="100" maxlength="100" readonly></b></td>
        <br>
        <br>              
