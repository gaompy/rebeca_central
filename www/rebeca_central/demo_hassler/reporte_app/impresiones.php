...
$sel="SELECT replace(format(SUM(total),0),',','.') as suma from ($contenido) as tmp";
$res=mysql_query($sel);
$total_gral=mysql_result($res,0,"suma");
...
$titles = array(
				...
				'fac_cod'=>'<b>Ticket</b>',
				'cli_des'=>'<b>Cliente</b>',
        'ven_des'=>'<b>Vendedores</b>',
        'total_format'=>'<b>Total ventas</b>',        
        'fecha'=>'<b>Fecha</b>'
...
$pdf->ezText("*************************************** Total General :  $total_gral en Gs. ***************************************",10);
