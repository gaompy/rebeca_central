...
if ($variable2 <> "") { $where.=" AND (select cli_des from clientes where cli_cod=factura_cab.cli_cod) like '%$variable2%'"; }
if ($variable3 <> "") { $where.=" AND (select ven_des from vendedores where usu_cod=factura_cab.usuario) like'%$variable3%'"; }
	...
	<body onload=inicio() oncontextmenu="return false">	
		<div id="pagina">
            ...
            FROM factura_cab WHERE borrado='0' and fac_est='0' and ".$where;
              ...
              <td width="25%"><div align="left"><?php echo strtoupper(mysql_result($res_resultado,$contador,"ven_des"));?></div></td>
              <td width="25%"><div align="left"><?php echo strtoupper(mysql_result($res_resultado,$contador,"total_format"));?></div></td>
