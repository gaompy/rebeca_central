...
<label class="title"><b><? echo "TOTAL = ".number_format($sumatotal, 0, ",", ".")." - CANT: ".$item; ?></b></label>
  ...
  <div class="element-number"><label class="title"><b>Cantidad</b><span class="required">*</span></label><div class="item-cont"><input class="medium" type="text" min="1" max="100000000" id="variable5" name="variable5" required="required" placeholder="Cantidad" value=""/><span class="icon-place"></span></div></div>
  <div class="element-number"><label class="title"><b>Precio p/Aut.</b><span class="required">*</span></label><div class="item-cont"><input class="medium" type="text" min="0" max="100000000" id="precio" name="precio" required="required" placeholder="Precio" value="0"/><span class="icon-place"></span></div></div>
...
$query="SELECT pro_bar,pro_des,pro_can FROM productos WHERE borrado=0 order by pro_des";
...
$pro_can=mysql_result($rs,$contador,"pro_can");
