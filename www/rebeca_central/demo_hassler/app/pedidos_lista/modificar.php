...
function inicio() {			
	...
	function guardar() {
	    ...
	    var variable5=document.getElementById("variable5").value;
			...
			location.href="guardar.php?variable1=" + variable1 +"&accion=alta"+"&variable4="+variable4+"&variable5="+variable5;
		}
...
<div class="title"><h2><? echo "PEDIDOS"; ?></h2></div>
  ...
  <div class="element-input"><label class="title"><b>Codigo Producto</b><span class="required">*</span></label><input class="large" type="text" name="variable4" id="variable4"  required="required" size="500" maxlength="500" /></div>
  <div class="element-input"><label class="title"><b>Cantidad</b><span class="required">*</span></label><input class="medium" type="text" name="variable5" id="variable5"  required="required" size="500" maxlength="500" /></div>
