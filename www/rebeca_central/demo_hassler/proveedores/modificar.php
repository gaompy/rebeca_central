...
$query="SELECT * FROM proveedores WHERE prv_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=strtoupper(mysql_result($rs_query,0,"prv_des"));
$variable3=strtoupper(mysql_result($rs_query,0,"prv_ruc"));
$variable4=strtoupper(mysql_result($rs_query,0,"prv_dir"));
$variable5=strtoupper(mysql_result($rs_query,0,"prv_tel"));
$variable6=strtoupper(mysql_result($rs_query,0,"prv_mai"));
