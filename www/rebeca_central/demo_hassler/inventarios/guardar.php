...
if ($accion=="alta") {
  ...
  $variable2_0=strtoupper($_POST["variable2_0"]);
	...
	$query_operacion="INSERT INTO inventario_cab(inv_cod,inv_des,dep_cod,inv_par,inv_fec,fecha,hora,usuario,borrado)
					VALUES ('$variable1','$variable2','$variable2_0','0','$variable3','$fecha','$hora','$usuario','0')";					
...
if ($accion=="modificar") {
  ...
  $variable2_0=strtoupper($_POST["variable2_0"]);	
	$variable3=strtoupper($_POST["variable3"]);
	$query="UPDATE inventario_cab SET inv_des='$variable2',inv_fec='$variable3',dep_cod='$variable2_0',fecha='$fecha',hora='$hora',usuario='$usuario' where inv_cod='$variable1'";
