...
function pon_prefijo(variable1,variable2,variable3,pro_cod,pro_ven) {
  ...
  parent.document.formulario_lineas.precio.value=pro_ven;
  parent.document.formulario_lineas.costo.value=variable3;
...
$i=0;
	...
	if (mysql_num_rows($rs_tabla)>0) {		
      ...
      $variablex=$estandar;
      $pro_ven=number_format(mysql_result($rs_tabla,$i,"pro_ven"), 0, ",", ".");
      
		
		?>
		<script languaje="javascript">
		pon_prefijo("<?php echo $variable1?>","<?php echo $variable3?>","<?php echo $variablex?>","<?php echo $pro_cod?>","<?php echo $pro_ven?>");
