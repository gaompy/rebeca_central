...
$query="select inv_cod, inv_des,inv_par as parametro ,
(select dep_des from depositos where dep_cod=inventario_cab.dep_cod) dep_des,
if(inv_par=0,'PENDIENTE','CONFIRMADO')as inv_par,inv_fec,fecha, hora, usuario, borrado
from inventario_cab where inv_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=strtoupper(mysql_result($rs_query,0,"inv_des"));
$variable2_0=strtoupper(mysql_result($rs_query,0,"dep_des"));
$variable3=strtoupper(mysql_result($rs_query,0,"inv_par"));
$variable4=strtoupper(mysql_result($rs_query,0,"inv_fec"));
$parametro=strtoupper(mysql_result($rs_query,0,"parametro"));
        ...
        if (param==0){
          ...
          if (confirm(" Desea Confirmar Listado ? ")){
           ...
           variable1="<?echo $variable1?>";           
			     location.href="procesarinventario.php?variable1="+variable1;           
           }
            }else{
            alert("Listado Confirmado!");
             }
...
<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				<div align="center">
				<div id="tituloForm" class="header">CARGA PRODUCTOS</div>
				<div id="frmBusqueda">
				<form id="formulario" name="formulario" method="post" action="guardar_factura.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
					 ...
					 <input NAME="nro_fac" value="<?echo $variable1?>" type="hidden" id="nro_fac" size="10" maxlength="5" readonly">	
						<tr>
						<tr>
							<td width="6%">Deposito</td>
						    <td width="27%"><input NAME="nombre" type="text" class="cajaGrande" id="nombre" size="45" maxlength="45" readonly value="<? echo $variable2_0?>"></td>
                <tr>
        ...
        <script type="text/javascript">
			  ...
			  <br>
			   <div id="frmBusqueda">
				...
				<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
				  ...
				  <tr>
					<td width="5%">Costo</td>
					<td width="11%"><input NAME="costo" onkeyup="format(this)" type="text" class="cajaTotales" id="costo" size="10"  maxlength="10" ></td>					
				  <tr>  
          ...
          <tr>
            <td width="5%">Cantidad</td>
					...
					<td width="5%">Total Costo</td>
					<td width="1%"><input NAME="total_costo" type="text" class="cajaTotales" id="total_costo" size="10" maxlength="10" readonly></td>
					<td width="5%">Total Venta</td>
					<td width="1%"><input NAME="total_venta" type="text" class="cajaTotales" id="total_venta" size="10" maxlength="10" readonly></td>
					...
					<td width="1%"><img src="../../img/boton-confirmar.jpg" width="90" height="27" border="0" onClick="confirmar()" onMouseOver="style.cursor=cursor" title="Confirmar"></td>				  
