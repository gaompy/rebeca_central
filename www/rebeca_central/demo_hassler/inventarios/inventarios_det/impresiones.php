...
$titles = array(
        ...
        'pro_ven_for'=>'<b>Venta</b>',
			  'pro_tot_cos_for'=>'<b>Total Costo</b>',
        'pro_tot_ven_for'=>'<b>Total Venta</b>',
...
$costo=mysql_result($res_resultado,$contador,"pro_cos_tot_for");
$venta=mysql_result($res_resultado,$contador,"pro_ven_tot_for");
$dep_des=mysql_result($res_resultado,$contador,"dep_des");
...
$pdf->ezText("<b>Costo Total :</b> ".$venta."", 10);
