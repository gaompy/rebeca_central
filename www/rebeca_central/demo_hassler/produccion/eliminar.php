...
$query="SELECT * FROM produccion_view WHERE prd_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=mysql_result($rs_query,0,"pro_bar");
$variable3=mysql_result($rs_query,0,"pro_des");
$variable4=mysql_result($rs_query,0,"prd_can");
