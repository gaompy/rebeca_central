...
if ($variable5 <> "") { $where.=" AND prd_fec >='$variable5'"; }
if ($variable6 <> "") { $where.=" AND prd_fec <='$variable6'"; }



$where.=" ORDER BY prd_cod desc";
$query_busqueda="SELECT count(*) as filas FROM produccion_view WHERE borrado=0 AND ".$where;
		...
		<div id="pagina">
			...
			<input type="hidden" name="numfilas" id="numfilas" value="<?php echo $filas; ?>">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						<?php $sel_resultado="SELECT * from produccion_view where borrado='0' and ".$where;
						   include("sql.php");
						...
						<tr class="<?php echo $fondolinea;?>">
							...
							?>
							<td width="5%"><div align="center"><a href="javascript:ver(<?php echo mysql_result($res_resultado,$contador,"prd_cod")?>)"><img src="../img/ver.png" width="16" height="16" border="0"  title="Visualizar"></a></div></td>
							<?php  
							if (@$eli=='0'){
							?>							
							<td width="6%"><div align="center"><a href="javascript:eliminar(<?php echo mysql_result($res_resultado,$contador,"prd_cod")?>)"><img src="../img/eliminar.png" width="16" height="16" border="0"  title="Eliminar"></a></div></td>						
							<?php
							}
							?>
