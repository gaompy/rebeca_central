			...
			<div align="center">
                ...
                <tr>    
                    <td width="3%">RUC</td>
					   ...
					   <?php
					  $query="SELECT * FROM tipo_envio where borrado=0 and tie_cod='2' ORDER BY tie_cod ASC";
					  ...
					  ?>						
						...
						<td width="15%">Formas Pago</td>
							<td width="43%"><select id="variable4" name="variable4" class="comboMedio" onChange="buscar()">
								...
								<option value="<?php echo mysql_result($res,$contador,"tie_cod"); ?>"><?php echo strtoupper(mysql_result($res,$contador,"tie_des"));?></option>
								<?php $contador++;
								} ?>				
								</select>							</td>
				        </tr>
