...
function Cezpdf($paper='a4',$orientation='portrait'){
	...
	if (!is_array($paper)){
      ...
      case 'TICKET':  {$size = array(0,0,144.70,604.88); break;}
      case 'FACTURA': {$size = array(0,0,612.00,612.00); break;}
			...
			case 'CHORIZOS':{$size = array(0,0,637.80,907.09); break;}
		}
