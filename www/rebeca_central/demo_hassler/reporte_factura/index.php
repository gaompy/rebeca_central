...
function imprimir() {
      ...
      alert("El numero de factura debe ser valido!");
    		...
    		miPopup = window.open("reporte/impresiones.php?nrofactura="+nrofactura+"&importe="+total+"&factura="+factura+"&codcliente="+codcliente,"miwin","width=700,height=380,scrollbars=yes");
	   		miPopup.focus();
      }
		}
