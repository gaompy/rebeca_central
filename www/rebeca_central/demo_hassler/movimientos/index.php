...
function excel() {
	...
	<tr>
				   ...
				   <?php
					  $query="SELECT * FROM tipo_cuenta where borrado=0 ORDER BY tcu_des ASC";
				   ...
				   <?php
					  $query="SELECT * FROM tipo_moneda ORDER BY tmo_des ASC";
						$res=mysql_query($query);
						$contador=0;
					  ?>						
            ...
            <td width="15%">Tipo Mov.</td>
							<td width="43%"><select id="variable6" name="variable6" class="comboMedio" onChange="buscar()">
							<option value="">Todos</option>
