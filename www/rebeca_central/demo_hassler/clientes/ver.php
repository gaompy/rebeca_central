...
$variable0=strtoupper(mysql_result($rs_query,0,"codigoanterior"));
...
var miPopup
  ...
  <?
      $q="SHOW COLUMNS FROM clientes_view";
      $r=mysql_query($q);
         
         		for ($i = 0; $i < mysql_num_rows($r); $i++) {
            		
                $variable1_0=mysql_result($r,$i,"Field");
                $variable2_0=strtoupper(mysql_result($rs_query,0,$variable1_0));
                
                ?>
              <tr>
							<td width="15%"><?echo $variable1_0?></td>
