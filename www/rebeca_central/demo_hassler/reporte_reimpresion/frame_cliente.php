...
function pon_prefijo(variable1,variable2,variable3,variable4) {
	parent.opener.document.formulario.codcliente.value=variable1;
  parent.opener.document.formulario.nombre.value=variable2;
  parent.opener.document.formulario.nif.value=variable3;
  parent.opener.document.formulario.tipo_des.value=variable4;  
  parent.opener.document.formulario.factura.focus();  
 	parent.window.close();
}
</script>
...
<? if ($nrs>0) { ?>
        ...
        <div align="left"><?php echo $tic_des;?></div></td>	
					<td align="center"><div align="center"><a href="javascript:pon_prefijo('<? echo $cli_cod ?>','<? echo $cli_des ?>','<? echo $cli_ruc ?>','<? echo $tic_des ?>')"><img src="../img/convertir.png" border="0" title="Seleccionar"></a></div></td>					
        </tr>
			<?php }
		?>
  </table>
