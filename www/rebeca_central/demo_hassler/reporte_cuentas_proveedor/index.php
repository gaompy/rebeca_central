...
function imprimir(variable1) {
     if (variable1==1){
			...
			miPopup = window.open("impresiones_contabilidad.php","miwin","width=700,height=380,scrollbars=yes");
			miPopup.focus();      
      }
}
...
function excel() {
	...
	<body onLoad="inicio()">
		<div id="pagina">
                ...
                <tr>    
                    <td width="3%">RUC</td>
					  ...
					  ?>						
						...
						<td width="15%">Tipo Doc.(Compra, NC.)</td>
            ...
            <td>Fecha Inicio</td>
						  <td><input id="fecha_inicio" type="text" value="<?echo $fecha_inicio?>" class="cajaPequena" NAME="fecha_inicio" maxlength="10" readonly><img src="../img/calendario.png" name="Image1" id="Image1" width="16" height="16" border="0" onMouseOver="this.style.cursor='pointer'">
        <script type="text/javascript">
					...
					button     : "Image1"
						  ...
						  <td>Fecha Fin</td>
						  <td><p>
						    <input id="fecha_fin" type="text" value="<?echo $fecha?>" class="cajaPequena" NAME="fecha_fin" maxlength="10" readonly>
          ...
          <img src="../img/botoncontabilidad.png" width="79" height="22" border="1" onClick="imprimir(2)" onMouseOver="style.cursor=cursor">
