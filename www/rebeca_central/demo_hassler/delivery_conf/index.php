...
<html>
	...
	<script language="javascript">
		...
		function validar_cabecera(){
				...
				if (document.getElementById("diferencia").value=="") mensaje+="  - Recibido\n";				
				if (mensaje!="") {
					alert("Atencion, se han detectado las siguientes incorrecciones:\n\n"+mensaje);
				} else {					
						
					if (confirm(" Desea guardar registro? ")){ 
                location.href="guardar_cliente.php?nrofactura="+nrofactura+"&diferencia="+diferencia;
				  	}
				}
		...
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="formulario" name="formulario" >
					...
					<input NAME="saldo" type="hidden" class="cajaTotales" id="saldo" size="10" maxlength="10" readonly></td>
							</tr>					
						<tr>
					<td width="5%">Recibido por</td>
					<td width="27%"><input NAME="diferencia" type="text" class="cajaGrande" id="diferencia" size="100" maxlength="100"></td>
