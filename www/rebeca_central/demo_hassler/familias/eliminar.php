...
$query="SELECT *, 
(CASE fam_par WHEN 0 THEN 'No' WHEN 1 THEN 'Si' END)AS fam_par_des
 FROM familias_pro WHERE fam_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=mysql_result($rs_query,0,"fam_des");
$variable3_1=strtoupper(mysql_result($rs_query,0,"fam_par_des"));
				...
				<div id="frmBusqueda">
					...
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
					 	...
					 	<tr>
							<td width="15%">Comanda y Panel</td>
						    <td width="85%" colspan="2"><?php echo $variable3_1?></td>
					    </tr> 
					</table>
			  </div>
