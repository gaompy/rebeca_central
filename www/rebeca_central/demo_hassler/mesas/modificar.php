...
$query="SELECT * FROM mesas WHERE mes_cod='$variable1'";
$rs_query=mysql_query($query);
$variable2=strtoupper(mysql_result($rs_query,0,"mes_des"));
$variable3=mysql_result($rs_query,0,"mes_tip");
if ($variable3==1){
  $variable3_1="Mesas";
}else{
  $variable3_1="Habitaciones";
}
