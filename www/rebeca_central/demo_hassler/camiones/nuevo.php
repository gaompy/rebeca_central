...
function guardar()
        ...
        if (document.getElementById("variable3").value=="") mensaje+="  - Chapa\n";
        if (document.getElementById("variable4").value=="") mensaje+="  - Kilos\n";
  ...
  function inicio(){
	...
	<body onLoad="inicio()">
		<div id="pagina">
            ...
            <tr>
							<td width="15%">Kilos</td>
						    <td width="43%"><input NAME="variable4" type="text" value="0" class="cajaMedia" id="variable4" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
