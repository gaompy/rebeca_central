...
$fecha_compra=$_POST["variable5"];
			...
			$consulta="SELECT count(*) as cuenta FROM compra_cab WHERE (fac_cod='$fac_cod') and prv_cod='$cli_cod' and borrado='0'";
...
/*                
            $sel="update mesas set mes_fac='$fac_cod',mes_est='1' where mes_cod='$mes_cod'";
       			...
       			$sel="update compra_cab set prv_cod='$cli_cod',mes_cod='$mes_cod',fecha='$fecha_compra' where fac_cod='$fac_cod'";
						$rs=mysql_query($sel);	
					  /*
