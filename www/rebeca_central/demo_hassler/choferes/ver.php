...
$query="SELECT * FROM choferes WHERE cho_cod='$variable1'";
$rs_query=mysql_query($query);

$variable2=strtoupper(mysql_result($rs_query,0,"cho_des"));
$variable3=strtoupper(mysql_result($rs_query,0,"cho_dir"));
$variable4=strtoupper(mysql_result($rs_query,0,"cho_tel"));
$variable5=strtoupper(mysql_result($rs_query,0,"cho_ema"));
