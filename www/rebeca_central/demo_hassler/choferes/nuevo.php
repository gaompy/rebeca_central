...
function guardar()
			...
			{
				var mensaje="";
        if (document.getElementById("variable2").value=="") mensaje+="  - Nomber y Apellido\n";
	...
	<body onLoad="inicio()">
		<div id="pagina">
			<div id="zonaContenido">
				...
				<form id="formulario" name="formulario" method="post" action="guardar.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						<tr>
							<td width="15%">Nompbre y Apellido</td>
            ...
            <tr>
						    ...
						    <td width="43%"><input NAME="variable4" type="text" value="--" class="cajaMedia" id="variable4" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
            
            <tr>
							<td width="15%">Email</td>
						    <td width="43%"><input NAME="variable5" type="text" value="--"class="cajaGrande" id="variable5" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>		
