...
$query_busqueda="SELECT count(*) as filas FROM productos_view WHERE borrado=0 AND  pro_can >'0' and ".$where;
		...
		<div id="pagina">
			...
			<input type="hidden" name="numfilas" id="numfilas" value="<?php echo $filas; ?>">
				...
				if ($iniciopagina>$filas) { $iniciopagina=0; }
					if ($filas > 0) { ?>
						<?php $sel_resultado="SELECT *, REPLACE(FORMAT((pro_ven-pro_cos),0),',','.') AS pro_uti from productos_view where borrado='0' and pro_can >'0' and ".$where;
						   include("sql.php");
						...
						<tr class="<?php echo $fondolinea;?>">
							...
							<td width="12%"><div align="center"><?php echo mysql_result($res_resultado,$contador,"pro_cod");?></div></td>
