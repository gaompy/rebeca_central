	...
	<body onLoad="inicio()">
		<div id="pagina">
           ...
           <tr>
						    ...
						    <td width="43%"><input NAME="variable6" type="text" value="<?echo $variable6?>"class="cajaMedia" id="variable6" size="45" maxlength="45" readonly="yes"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
			     ...
			     <tr>
						    ...
						    <td width="43%"><input NAME="variable7" type="text"  value="<?echo $variable7?>" class="cajaMedia" id="variable7" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>		            		
