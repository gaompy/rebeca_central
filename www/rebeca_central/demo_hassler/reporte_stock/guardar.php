...
if ($accion=="alta") {
  ...
  pro_can, 	pro_imp, 	par_cod, 	fam_cod, 	uni_cod, 	fecha, 	hora, 	usuario, 	borrado 	) 
  	VALUES 	('$variable1', 	'$variable2', 	'$variable3', 	'$variable4', 	'$variable5', 	
    '$variable6', 	'$variable7', 	'$variable8', 	'$variable9', 	'$variable10', 	'$fecha', 
    	'$hora', 	'$usuario', 	'0' 	)";			
...
if ($accion=="modificar") {
  ...
  par_cod = '$variable8' , 	fam_cod = '$variable9' , 	uni_cod = '$variable10' , 	fecha = '$fecha' , 	
  hora = '$hora' , 	usuario = '$usuario' 	WHERE 	pro_cod = '$variable1' ";
