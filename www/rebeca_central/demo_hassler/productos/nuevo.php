...
function guardar()
        ...
        if (document.getElementById("variable11").value=="") mensaje+="  - Marcas\n";
        if (document.getElementById("variable12").value=="") mensaje+="  - Envase\n";
        if (document.getElementById("peso").value=="") mensaje+="  - Peso\n";
        if (document.getElementById("litro").value=="") mensaje+="  - Litro\n";
	...
	<body onLoad="inicio()">
		<div id="pagina">
				...
				<form id="formulario" name="formulario" method="post" action="guardar.php">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<tr>
						    ...
						    <td width="43%"><input NAME="variable4" type="text" value=""  onkeyup="format(this)" onchange="format(this)" class="cajaPequena" id="variable4" size="245" maxlength="245"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
            						<tr>
							<td width="15%">Venta</td>
						    <td width="43%"><input NAME="variable5" type="text" value="" onkeyup="format(this)" onchange="format(this)" class="cajaPequena" id="variable5" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
           <tr>
           ...
           <tr>
						    ...
						    <td width="43%"><input NAME="peso" type="text" value="0" class="cajaMedia" id="peso" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>

           <tr>
							<td width="15%">Litro (LT.)</td>
						    <td width="43%"><input NAME="litro" type="text" value="0" class="cajaMedia" id="litro" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
  ...
  <?php
					  $query="SELECT * FROM marcas where borrado='0' ORDER BY mar_des ASC";
						$res=mysql_query($query);
						$contador=0;
					  ?>						
