...
$variable13=mysql_result($rs_query,0,"pro_pes");
$variable14=mysql_result($rs_query,0,"pro_lit");
	...
	<body onLoad="inicio()">
		<div id="pagina">
           ...
           <tr>
						    ...
						    <td width="43%"><input NAME="peso" type="text" value="<?echo $variable13?>" class="cajaMedia" id="peso" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>

           <tr>
							<td width="15%">Litro (LT.)</td>
						    <td width="43%"><input NAME="litro" type="text" value="<?echo $variable14?>" class="cajaMedia" id="litro" size="45" maxlength="45"></td>
					        <td width="42%" rowspan="12" align="left" valign="top"><ul id="lista-errores"></ul></td>
						</tr>
