		...
		<div id="pagina">
			...
			<div align="center">
				...
				<form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
					<table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
						<tr>
							...
							<td width="68%"><input id="variable1" type="text" class="cajaMedia" NAME="variable1"  size="45" maxlength="45"  onChange="buscar()">  <img src="../img/ver.png" width="16" height="16" onClick="buscar()" title="Buscar Materia" onMouseOver="style.cursor=cursor"></td>
							<td width="5%">&nbsp;</td>
							<td width="5%">&nbsp;</td>
			  ...
			  <table class="fuente8" width="80%" cellspacing=0 cellpadding=3 border=0>
               ...
               <td width="8%">P.Venta</td>
							<td width="8%">precios</td>
