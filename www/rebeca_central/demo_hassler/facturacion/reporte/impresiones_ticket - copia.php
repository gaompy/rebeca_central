 ...
 $pro_ven=mysql_result($res,$i,"pro_ven"); 
  ?>
    ...
    <td width="1"><span class="x">
      ...
      <td width="50"><span class="x">
      <label for="variable1"><?echo substr(($pro_des),0,100) ?><br />
      </label>
    </span></td>
  
       <td width="20">      <span class="x">
      <label for="variable1"><?echo number_format($pro_ven, 0, ",", ".")."/" ?><br />
      </label>
    </span></td> 
    
    <td width="85">      <span class="x">
