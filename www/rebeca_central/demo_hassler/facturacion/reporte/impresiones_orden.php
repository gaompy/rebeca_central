...
$variable2=$_GET["mesa"];
$query="select *,REPLACE(FORMAT(pro_tot,0),',','.')AS pro_ven,(select pro_des from productos where pro_cod=factura_det.pro_cod)
as pro_des from factura_det where fac_cod='$variable2' and borrado='0' order by mde_cod desc";
...
$txttit.= "<b>          $emp_des</b>\n";
$txttit.= "<b> ----------------------------------------</b>\n";
$txttit.= "<b> Orden Nro.: $variable2</b>\n";
$txttit.= "<b> Mesa Nro.: $variable1</b>\n";
$txttit.= "<b> ----------------------------------------</b>\n";
$txttit.= "<b> DESC. CANT.</b>\n";
$txttit.= "<b> ----------------------------------------</b>\n";
