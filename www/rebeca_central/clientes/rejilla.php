...
$where="1=1";
if ($variable1 <> "") { $where.=" AND cli_cod='$variable1'"; }
if ($variable2 <> "") { $where.=" AND cli_des like '%".$variable2."%'"; }
if ($variable3 <> "") { $where.=" AND cli_ruc like '%".$variable3."%'"; }
if ($variable4 <> "") { $where.=" AND med_cod='$variable4'"; }
if ($variable5 <> "") { $where.=" AND tic_cod='$variable5'"; }
if ($variable6 <> "") { $where.=" AND cli_par='$variable6'"; }
...
<html>
	...
	<body onload=inicio() oncontextmenu="return false">	
		<div id="pagina">
            ...
            from clientes_view where borrado='0' and ".$where;
						   include("sql.php");
						...
						<tr class="<?php echo $fondolinea;?>">
							...
							<td width="12%"><div align="center"><?php echo mysql_result($res_resultado,$contador,"cli_cod");?></div></td>
							...
							if (@$mod=='0'){
							?>
							<td width="5%"><div align="center"><a href="javascript:modificar(<?php echo mysql_result($res_resultado,$contador,"cli_cod")?>)"><img src="../img/modificar.png" width="16" height="16" border="0"  title="Modificar"></a></div></td>
							<?php
							}
							?>
							<td width="5%"><div align="center"><a href="javascript:ver(<?php echo mysql_result($res_resultado,$contador,"cli_cod")?>)"><img src="../img/ver.png" width="16" height="16" border="0"  title="Visualizar"></a></div></td>
							<?php  
							if (@$eli=='0'){
							?>							
							<td width="6%"><div align="center"><a href="javascript:eliminar(<?php echo mysql_result($res_resultado,$contador,"cli_cod")?>)"><img src="../img/eliminar.png" width="16" height="16" border="0"  title="Eliminar"></a></div></td>						
							<?php
							}
							?>
