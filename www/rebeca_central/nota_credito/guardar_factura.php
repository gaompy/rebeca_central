...
<body onLoad="inicio()">
		<div id="pagina">
          ...
          <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
						...
						<p>  <td width="85%" colspan="2" class="mensaje">CIERRE DE NC</td>   </p>
					    </tr>				          
					  <?php
		        ...
		        ?>
				 ...
				 <input NAME="variable4" type="hidden"  id="variable4" value="0" readonly >
						...
						<td width="6%">Importe</td>
						    <td width="27%"><input NAME="variable5" onKeyUp="format(this)"  type="text" class="cajaMedia" id="variable5" size="45" maxlength="45" ></td>    			
					<tr>		
						<td>Total a Pagar</td>
